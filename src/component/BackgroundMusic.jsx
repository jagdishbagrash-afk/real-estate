...
const BackgroundMusic = () => {
  ...
  // Optional: Pause on route change
  useEffect(() => {
    if (audioRef.current) {
      audioRef.current.pause();
      setPlaying(false);
  ...
  return (
    <div>
      ...
      <button onClick={handleToggle} className="p-[0] bg-none border-none text-white">
        {playing ? <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
