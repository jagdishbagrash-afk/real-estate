...
const TestimonialSlider = () => {
  return (
    <div className="clintSays bg-[#F8F6F2] py-[100px] text-center px-4">
      <h2 className="fontspring text-[30px] md:text-[40px] lg:text-[50px] mb-[45px] text-[#000112]">
...
>
        ...
        {/* Custom Arrows */}
        <div className="prev-btn bg-white absolute left-4 top-1/2 transform -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center border border-[#FF792D] text-[#FF792D] rounded-full hover:bg-orange-500 hover:text-white transition-colors duration-300 cursor-pointer">
...
<path d="M17.328 4.99977V6.99977H4.5L7.743 10.2428L6.328 11.6568L0.672001 5.99977L6.328 0.342773L7.743 1.75677L4.5 4.99977H17.328Z" fill="currentColor"/>
        ...
        <div className="next-btn bg-white absolute right-4 top-1/2 transform -translate-y-1/2 z-10 w-10 h-10 flex items-center justify-center border border-[#FF792D] text-[#FF792D] rounded-full hover:bg-orange-500 hover:text-white transition-colors duration-300 cursor-pointer">
        <svg width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
