...
function Main() {
  return (
    <div className="min-h-screen ">
      <Header />
      <div className="relative h-[860px] mt-[-150px]">
      ...
      <section className="bg-white py-[100px]">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h2 className="fontspring text-[25px] text-[50px] leading-[55px] text-[#000112]">
              Creating Beautiful Spaces <br /> Since 2010
             
            </h2>
            <p className="mt-6 text-[20px] font-[400] text-[#00011299]">
            ...
            <button className="min-w-[250px] mt-8 px-6 py-3 border border-[94A393] text-[#94A393] text-[14px] font-[600] tracking-wide text-[#94A393] hover:bg-[#94A393] hover:text-[#fff] transition-all uppercase tracking-wider">
              More About Us
            </button>
          </div>
        </div>
